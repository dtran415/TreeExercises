...
class Tree {
    ...
    sumValues(node = this.root) {
        ...
        // add up the sum of this node plus all its children
        let sum = node.val;
    ...
    countEvens(node = this.root) {
        ...
        // if this node is even it returns 1, then recurse through children
    ...
    numGreater(lowerBound, node = this.root) {
        ...
        // if this node is greater than lowerBound return 1, then recurse through children
